...
abstract class CoreEntity extends Core implements CoreInterface, CoreEntityInterface, MetaInterface
{
    ...
    protected function fetch_meta($field_name = '', $args = [], $apply_filters = \true)
    {
        ...
        $args = \wp_parse_args($args, ['transform_value' => $transform_value]);
        $object_meta = null;
        ...
        if ($apply_filters) {
             ...
             */
            $object_meta = \apply_filters("timber/{$object_type}/pre_meta", $object_meta, $this->ID, $field_name, $this, $args);
            if ($object_type !== 'term') {
                /**
                 ...
                 */
                $object_meta = \apply_filters_deprecated("timber_{$object_type}_get_meta_field_pre", [$object_meta, $this->ID, $field_name, $this], '2.0.0', "timber/{$object_type}/pre_meta");
                /**
                 * Filters post meta data before it is fetched from the database.
                 *
                 * @deprecated 2.0.0, use `timber/{object_type}/pre_meta`
                 */
                \do_action_deprecated("timber_{$object_type}_get_meta_pre", [$object_meta, $this->ID, $this], '2.0.0', "timber/{$object_type}/pre_meta");
            }
        }
        if (null === $object_meta) {
            // Fetch values. Auto-fetches all values if $field_name is empty.
            $object_meta = \get_metadata($object_type, $this->ID, $field_name, \true);
        ...
        if ($apply_filters) {
             ...
             * @param array              $args       An array of arguments.
             */
            $object_meta = \apply_filters("timber/{$object_type}/meta", $object_meta, $this->ID, $field_name, $this, $args);
            if ($object_type === 'term') {
                /**
                 ...
                 */
                $object_meta = \apply_filters_deprecated('timber/term/meta/field', [$object_meta, $this->ID, $field_name, $this], '2.0.0', 'timber/term/meta');
            }
            /**
             ...
             */
            $object_meta = \apply_filters_deprecated("timber_{$object_type}_get_meta_field", [$object_meta, $this->ID, $field_name, $this], '2.0.0', "timber/{$object_type}/meta");
            /**
             * Filters object meta data fetched from the database.
             *
             * @deprecated 2.0.0, use `timber/{object_type}/meta`
             */
            $object_meta = \apply_filters_deprecated("timber_{$object_type}_get_meta", [$object_meta, $this->ID, $this], '2.0.0', "timber/{$object_type}/meta");
