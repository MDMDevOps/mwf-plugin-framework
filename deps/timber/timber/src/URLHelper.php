...
class URLHelper
{
    ...
    public static function file_system_to_url($fs)
    {
         ...
         */
        $home = \apply_filters_deprecated('timber/URLHelper/file_system_to_url', [$home], '2.0.0', 'timber/url_helper/file_system_to_url');
        return $home;
    }
    /**
    ...
    public static function get_content_subdir()
    {
         ...
         */
        $home_url = \apply_filters_deprecated('timber/URLHelper/get_content_subdir/home_url', [$home_url], '2.0.0', 'timber/url_helper/get_content_subdir/home_url');
