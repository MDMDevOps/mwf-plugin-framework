...
class Image extends Attachment implements ImageInterface
{
    ...
    {
        Helper::deprecated('Image::get_dimensions()', 'Image::get_width() | Image::get_height()', '2.0.0');
    ...
    {
        Helper::deprecated('Image::get_dimensions()', 'Image::get_width() or Image::get_height()', '2.0.0');
    ...
    {
        Helper::deprecated('{{ image.get_post_custom( image.id ) }}', "{{ image.meta('my_field') }}", '2.0.0');
    ...
    public function src($size = 'full') : string
    {
         ...
         */
        $src = \apply_filters_deprecated('timber_image_src', [$src, $this->ID], '2.0.0', 'timber/image/src');
        return $src;
    }
    /**
     * Get image sizes.
    ...
    {
        Helper::deprecated('Image::get_dimension()', 'Image::get_width() or Image::get_height()', '2.0.0');
