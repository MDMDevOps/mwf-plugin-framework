...
use Mwf\Lib\Deps\Twig\Node\Expression\Binary\AddBinary;
use Mwf\Lib\Deps\Twig\Node\Expression\Binary\AndBinary;
use Mwf\Lib\Deps\Twig\Node\Expression\Binary\BitwiseAndBinary;
use Mwf\Lib\Deps\Twig\Node\Expression\Binary\BitwiseOrBinary;
use Mwf\Lib\Deps\Twig\Node\Expression\Binary\BitwiseXorBinary;
use Mwf\Lib\Deps\Twig\Node\Expression\Binary\ConcatBinary;
use Mwf\Lib\Deps\Twig\Node\Expression\Binary\DivBinary;
use Mwf\Lib\Deps\Twig\Node\Expression\Binary\EndsWithBinary;
use Mwf\Lib\Deps\Twig\Node\Expression\Binary\EqualBinary;
use Mwf\Lib\Deps\Twig\Node\Expression\Binary\FloorDivBinary;
use Mwf\Lib\Deps\Twig\Node\Expression\Binary\GreaterBinary;
use Mwf\Lib\Deps\Twig\Node\Expression\Binary\GreaterEqualBinary;
use Mwf\Lib\Deps\Twig\Node\Expression\Binary\HasEveryBinary;
use Mwf\Lib\Deps\Twig\Node\Expression\Binary\HasSomeBinary;
use Mwf\Lib\Deps\Twig\Node\Expression\Binary\InBinary;
use Mwf\Lib\Deps\Twig\Node\Expression\Binary\LessBinary;
use Mwf\Lib\Deps\Twig\Node\Expression\Binary\LessEqualBinary;
use Mwf\Lib\Deps\Twig\Node\Expression\Binary\MatchesBinary;
use Mwf\Lib\Deps\Twig\Node\Expression\Binary\ModBinary;
use Mwf\Lib\Deps\Twig\Node\Expression\Binary\MulBinary;
use Mwf\Lib\Deps\Twig\Node\Expression\Binary\NotEqualBinary;
use Mwf\Lib\Deps\Twig\Node\Expression\Binary\NotInBinary;
use Mwf\Lib\Deps\Twig\Node\Expression\Binary\OrBinary;
use Mwf\Lib\Deps\Twig\Node\Expression\Binary\PowerBinary;
use Mwf\Lib\Deps\Twig\Node\Expression\Binary\RangeBinary;
use Mwf\Lib\Deps\Twig\Node\Expression\Binary\SpaceshipBinary;
use Mwf\Lib\Deps\Twig\Node\Expression\Binary\StartsWithBinary;
use Mwf\Lib\Deps\Twig\Node\Expression\Binary\SubBinary;
use Mwf\Lib\Deps\Twig\Node\Expression\Filter\DefaultFilter;
use Mwf\Lib\Deps\Twig\Node\Expression\NullCoalesceExpression;
use Mwf\Lib\Deps\Twig\Node\Expression\Test\ConstantTest;
use Mwf\Lib\Deps\Twig\Node\Expression\Test\DefinedTest;
use Mwf\Lib\Deps\Twig\Node\Expression\Test\DivisiblebyTest;
use Mwf\Lib\Deps\Twig\Node\Expression\Test\EvenTest;
use Mwf\Lib\Deps\Twig\Node\Expression\Test\NullTest;
use Mwf\Lib\Deps\Twig\Node\Expression\Test\OddTest;
use Mwf\Lib\Deps\Twig\Node\Expression\Test\SameasTest;
use Mwf\Lib\Deps\Twig\Node\Expression\Unary\NegUnary;
use Mwf\Lib\Deps\Twig\Node\Expression\Unary\NotUnary;
use Mwf\Lib\Deps\Twig\Node\Expression\Unary\PosUnary;
use Mwf\Lib\Deps\Twig\NodeVisitor\MacroAutoImportNodeVisitor;
use Mwf\Lib\Deps\Twig\TokenParser\ApplyTokenParser;
use Mwf\Lib\Deps\Twig\TokenParser\BlockTokenParser;
use Mwf\Lib\Deps\Twig\TokenParser\DeprecatedTokenParser;
use Mwf\Lib\Deps\Twig\TokenParser\DoTokenParser;
use Mwf\Lib\Deps\Twig\TokenParser\EmbedTokenParser;
use Mwf\Lib\Deps\Twig\TokenParser\ExtendsTokenParser;
use Mwf\Lib\Deps\Twig\TokenParser\FlushTokenParser;
use Mwf\Lib\Deps\Twig\TokenParser\ForTokenParser;
use Mwf\Lib\Deps\Twig\TokenParser\FromTokenParser;
use Mwf\Lib\Deps\Twig\TokenParser\IfTokenParser;
use Mwf\Lib\Deps\Twig\TokenParser\ImportTokenParser;
use Mwf\Lib\Deps\Twig\TokenParser\IncludeTokenParser;
use Mwf\Lib\Deps\Twig\TokenParser\MacroTokenParser;
use Mwf\Lib\Deps\Twig\TokenParser\SetTokenParser;
use Mwf\Lib\Deps\Twig\TokenParser\UseTokenParser;
use Mwf\Lib\Deps\Twig\TokenParser\WithTokenParser;
...
final class CoreExtension extends AbstractExtension
{
    ...
    public function getFilters() : array
    {
        return [
            // formatting filters
            new TwigFilter('date', '\\Mwf\\Lib\\Deps\\twig_date_format_filter', ['needs_environment' => \true]),
            new TwigFilter('date_modify', '\\Mwf\\Lib\\Deps\\twig_date_modify_filter', ['needs_environment' => \true]),
            new TwigFilter('format', '\\Mwf\\Lib\\Deps\\twig_sprintf'),
            new TwigFilter('replace', '\\Mwf\\Lib\\Deps\\twig_replace_filter'),
            new TwigFilter('number_format', '\\Mwf\\Lib\\Deps\\twig_number_format_filter', ['needs_environment' => \true]),
            new TwigFilter('abs', 'abs'),
            new TwigFilter('round', '\\Mwf\\Lib\\Deps\\twig_round'),
            // encoding
            new TwigFilter('url_encode', '\\Mwf\\Lib\\Deps\\twig_urlencode_filter'),
            new TwigFilter('json_encode', 'json_encode'),
            new TwigFilter('convert_encoding', '\\Mwf\\Lib\\Deps\\twig_convert_encoding'),
            // string filters
            new TwigFilter('title', '\\Mwf\\Lib\\Deps\\twig_title_string_filter', ['needs_environment' => \true]),
            new TwigFilter('capitalize', '\\Mwf\\Lib\\Deps\\twig_capitalize_string_filter', ['needs_environment' => \true]),
            new TwigFilter('upper', '\\Mwf\\Lib\\Deps\\twig_upper_filter', ['needs_environment' => \true]),
            new TwigFilter('lower', '\\Mwf\\Lib\\Deps\\twig_lower_filter', ['needs_environment' => \true]),
            new TwigFilter('striptags', '\\Mwf\\Lib\\Deps\\twig_striptags'),
            new TwigFilter('trim', '\\Mwf\\Lib\\Deps\\twig_trim_filter'),
            new TwigFilter('nl2br', '\\Mwf\\Lib\\Deps\\twig_nl2br', ['pre_escape' => 'html', 'is_safe' => ['html']]),
            new TwigFilter('spaceless', '\\Mwf\\Lib\\Deps\\twig_spaceless', ['is_safe' => ['html']]),
            // array helpers
            new TwigFilter('join', '\\Mwf\\Lib\\Deps\\twig_join_filter'),
            new TwigFilter('split', '\\Mwf\\Lib\\Deps\\twig_split_filter', ['needs_environment' => \true]),
            new TwigFilter('sort', '\\Mwf\\Lib\\Deps\\twig_sort_filter', ['needs_environment' => \true]),
            new TwigFilter('merge', '\\Mwf\\Lib\\Deps\\twig_array_merge'),
            new TwigFilter('batch', '\\Mwf\\Lib\\Deps\\twig_array_batch'),
            new TwigFilter('column', '\\Mwf\\Lib\\Deps\\twig_array_column'),
            new TwigFilter('filter', '\\Mwf\\Lib\\Deps\\twig_array_filter', ['needs_environment' => \true]),
            new TwigFilter('map', '\\Mwf\\Lib\\Deps\\twig_array_map', ['needs_environment' => \true]),
            new TwigFilter('reduce', '\\Mwf\\Lib\\Deps\\twig_array_reduce', ['needs_environment' => \true]),
            // string/array filters
            new TwigFilter('reverse', '\\Mwf\\Lib\\Deps\\twig_reverse_filter', ['needs_environment' => \true]),
            new TwigFilter('length', '\\Mwf\\Lib\\Deps\\twig_length_filter', ['needs_environment' => \true]),
            new TwigFilter('slice', '\\Mwf\\Lib\\Deps\\twig_slice', ['needs_environment' => \true]),
            new TwigFilter('first', '\\Mwf\\Lib\\Deps\\twig_first', ['needs_environment' => \true]),
            new TwigFilter('last', '\\Mwf\\Lib\\Deps\\twig_last', ['needs_environment' => \true]),
            // iteration and runtime
            new TwigFilter('default', '\\Mwf\\Lib\\Deps\\_twig_default_filter', ['node_class' => DefaultFilter::class]),
            new TwigFilter('keys', '\\Mwf\\Lib\\Deps\\twig_get_array_keys_filter'),
        ];
    }
    public function getFunctions() : array
    {
        return [new TwigFunction('max', 'max'), new TwigFunction('min', 'min'), new TwigFunction('range', 'range'), new TwigFunction('constant', 'twig_constant'), new TwigFunction('cycle', 'twig_cycle'), new TwigFunction('random', 'twig_random', ['needs_environment' => \true]), new TwigFunction('date', 'twig_date_converter', ['needs_environment' => \true]), new TwigFunction('include', 'twig_include', ['needs_environment' => \true, 'needs_context' => \true, 'is_safe' => ['all']]), new TwigFunction('source', 'twig_source', ['needs_environment' => \true, 'is_safe' => ['all']])];
    }
    public function getTests() : array
    {
        return [new TwigTest('even', null, ['node_class' => EvenTest::class]), new TwigTest('odd', null, ['node_class' => OddTest::class]), new TwigTest('defined', null, ['node_class' => DefinedTest::class]), new TwigTest('same as', null, ['node_class' => SameasTest::class, 'one_mandatory_argument' => \true]), new TwigTest('none', null, ['node_class' => NullTest::class]), new TwigTest('null', null, ['node_class' => NullTest::class]), new TwigTest('divisible by', null, ['node_class' => DivisiblebyTest::class, 'one_mandatory_argument' => \true]), new TwigTest('constant', null, ['node_class' => ConstantTest::class]), new TwigTest('empty', 'twig_test_empty'), new TwigTest('iterable', 'is_iterable')];
    }
...
use Mwf\Lib\Deps\Twig\Error\LoaderError;
use Mwf\Lib\Deps\Twig\Error\RuntimeError;
use Mwf\Lib\Deps\Twig\Extension\CoreExtension;
use Mwf\Lib\Deps\Twig\Extension\SandboxExtension;
use Mwf\Lib\Deps\Twig\Markup;
use Mwf\Lib\Deps\Twig\Source;
use Mwf\Lib\Deps\Twig\Template;
use Mwf\Lib\Deps\Twig\TemplateWrapper;
/**
 * Cycles over a value.
 *
...
{
    if (!$arrow instanceof \Closure && $env->hasExtension('Mwf\\Lib\\Deps\\Twig\\Extension\\SandboxExtension') && $env->getExtension('Mwf\\Lib\\Deps\\Twig\\Extension\\SandboxExtension')->isSandboxed()) {
