...
use Mwf\Lib\Deps\Composer\DependencyResolver\Pool;
use Mwf\Lib\Deps\Composer\Semver\Constraint\Constraint;
/** @internal */
class CakePHPInstaller extends BaseInstaller
{
    ...
    public function inflectPackageVars(array $vars) : array
    {
        ...
        foreach ($nameParts as &$value) {
            $value = \strtolower($this->pregReplace('/(?<=\\w)([A-Z])/', 'Mwf\\Lib\\Deps\\_\\1', $value));
