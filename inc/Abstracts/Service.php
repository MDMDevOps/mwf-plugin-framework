 ...
 */
abstract class Service extends Loadable implements Interfaces\Service
{
	/**
	 ...
	 * Default constructor
	 *
	 * Child classes can implement logic to disable the class during construction
	 *
	 * @param boolean $enabled : optional, whether or not the service is enabled.
	 */
